...
public class UsersContentProvider extends ContentProvider {
    ...
    public static UriMatcher buildUriMatcher() {
        ...
        uriMatcher.addURI(UserContract.AUTHORITY, UserContract.PATH_USERS + "/#", Users_WITH_ID);
    ...
    public boolean onCreate() {
        ...
        mUsersDbHelper = new db_helper(context);
        return true;
    }
    ...
    public Uri insert(@NonNull Uri uri, ContentValues values) {
        ...
        switch (match) {
            case Users:
                ...
                if ( id > 0 ) {
                    returnUri = ContentUris.withAppendedId(UserContract.USERS_ENTERY.CONTENT_URI, id);
                } else {
